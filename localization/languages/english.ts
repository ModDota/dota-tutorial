const goals = {
    // Chapter 1: SectionTemplate
    GoalDummy: "Do something.",

    // Chapter 1: SectionCameraUnlock
    GoalMoveCamera: "Move your camera by dragging the cursor to the edge of your screen.",
    GoalKillDummy: "Attack and destroy the target dummy by right-clicking it.",
    GoalKillSunsfan: "Attack SUNSfan.",
    // Chapter 1: SectionCasting
    GoalKillSlacks: "Kill Slacks using your Breathe Fire ability.",
    // Chapter 1: SectionLeveling
    GoalKillPurge: "Stun Pugna Purge using your Dragon Tail ability to stop his monologue.",
    GoalLevelDragonTail: "Level up your Dragon Tail ability.",
    GoalLevelBreatheFire: "Level up your Breathe Fire ability.",
    // Chapter 1: SectionMovement
    GoalMoveToFirstMarker: "Move to the marked waypoint.",
    GoalMoveToSecondMarker: "Move to the second waypoint.",
    // Chapter 1: SectionShopUI
    GoalOpenShop: "Open the shop.",
    GoalBuyTango: "Use the gold provided to purchase a Tango.",
};
...
export default { ...goals, ...ui, ...errors, ...voiceover };