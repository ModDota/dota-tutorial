...
export const chapter5Blockades = {
    ...
    direOutpostRiver: new Blockade(Vector(-1450, 2700, 0), Vector(-1150, 2400, 0)),
    roshan: new Blockade(Vector(-2528, 1760, 7), Vector(-2235, 2215, 12)),
    radiantAncientsRiver: new Blockade(Vector(-3060, 1010, 0), Vector(-2830, 760, 0)),
...
export const runeSpawnsLocations = {
    ...
    direAncientsBountyPos: Vector(3200, -580, 304),
