...
const onStart = (complete: () => void) => {
    ...
    const goalMoveCamera = goalTracker.addBoolean(LocalizationKey.GoalMoveCamera);
    const goalKillDummy = goalTracker.addBoolean(LocalizationKey.GoalKillDummy);
    const goalKillSunsfan = goalTracker.addBoolean(LocalizationKey.GoalKillSunsfan);
