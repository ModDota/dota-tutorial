 ...
 */
export function highlightUiElement(path: string, duration?: number, mouseIcon?: HighlightMouseButton, animateFromBelow?: boolean) {
    CustomGameEventManager.Send_ServerToAllClients("highlight_element", { path, duration, mouseIcon, animateFromBelow });
}
...
export type HighlightType = "circle" | "arrow" | "arrow_enemy" | "dialog_circle" | "arrow_trees"
